    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark my-navbar">
            <div className="container-fluid">
                <Link className="navbar-brand text-uppercase" href="https://www.seekpng.com/ipng/u2e6a9t4y3u2i1q8_lock-and-key-royalty-free-vector-clip-art/"><img className="logo" src={rockLockImage} alt=""/>Rock-Lock</Link>
                ...
                <div className="collapse navbar-collapse text-center" id="navbarNavAltMarkup">
                    <div class="navbar-nav ms-auto">
                        ...
                        <Link className="nav-link navbar-links" to="/blogs">Blogs</Link>
                        <Link className="nav-link navbar-links" to="/contact">Contact</Link>
                        <Link className="nav-link navbar-links disabled" to="/deals" tabIndex="-1" ariaDisabled="true">Shop</Link>
                        {
